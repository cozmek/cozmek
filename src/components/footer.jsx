      ...
      <footer className="relative w-full font-montserrat">
        ...
        <div className="mx-auto w-[85%] mt-10">
          <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
            <div className="md:w-[80%] w-full">
              <Typography variant="h5" className="font-bold flex flex-col">
                ...
                <span className="flex flex-col text-sm text-[#737373] font-normal mt-5">
                  ...
                  achieve worldwide prominence in AI-driven innovations via our
                  AI Labs and Projects. Our aspiration is to construct the most
                  extensive AI ecosystem globally. Cozmek primarily delivers AI
                  programs through online, addon, and offline sessions.
                  <span className="font-bold">
                    We extend a warm invitation to everyone.
                  </span>
                </span>
              </Typography>
              ...
              <div className="flex gap-4 text-blue-gray-900 mt-5">
                ...
                <Typography
                  as="a"
                  href="https://www.linkedin.com/company/cozmek-private-limited/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="opacity-80 transition-opacity hover:opacity-100"
                >
            ...
            {/* Options */}
            <div className="lg:grid flex flex-col text-center lg:text-start items-center mt-10 md:mt-0 lg:grid-cols-3 gap-4">
              {LINKS.map(({ title, items }) => (
                <ul key={title} className="mb-4 md:mb-0">
                  <Typography
                    variant="small"
                    className="mb-3 font-bold text-xl uppercase text-[#252B42] "
                  >
                    {title}
                  </Typography>
                  {items.map((link) => (
                    <li key={link}>
                      <Typography
                        ...
                        href="#"
                        color="gray"
                        className="py-1.5 font-bold text-sm text-[#737373]"
                      >
                        {link}
                      </Typography>
                    </li>
        ...
        {/* Bottom Footer */}
        <div className="mt-12 p-10 flex flex-col items-center justify-center bg-[#73969D] bg-opacity-[23%] py-4 md:flex-row md:justify-between">
          <div className="flex gap-10">
            ...
            <Typography
              variant="small"
              className="mb-4 text-center font-bold text-[#000000] md:mb-0"
            >
              Cozmek Private Limited
            </Typography>
            <Typography
              variant="small"
              className="mb-4 text-center font-normal text-[#6B7385] md:mb-0"
